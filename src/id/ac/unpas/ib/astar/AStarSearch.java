...
public class AStarSearch {
    private List<Node> path; // atribut kelas yang digunakan untuk menyimpan jalur yang telah dilewati selama pencarian. 

    // untuk menginisialisasi objek AStarSearch dan objek path dalam list kosong.
    public AStarSearch() {
        path = new ArrayList<>();
    }
